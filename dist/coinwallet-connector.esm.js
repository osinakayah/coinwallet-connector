...
var CoinWalletConnector = /*#__PURE__*/function (_AbstractConnector) {
  _inheritsLoose(CoinWalletConnector, _AbstractConnector);

  function CoinWalletConnector(kwargs) {
    var _this3;
  ...
  var _proto = CoinWalletConnector.prototype;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              if (window.eth.isMetaMask) {
                window.eth.autoRefreshOnNetworkChange = false;
              } // try to activate + get account via eth_requestAccounts


              _context.prev = 4;
              _context.next = 7;
              return window.eth.send('eth_requestAccounts').then(function (sendReturn) {
            ...
            case 15:
              ...
              _context.next = 18;
              return window.eth.enable().then(function (sendReturn) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", window.eth);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              _context3.prev = 2;
              _context3.next = 5;
              return window.eth.send('eth_chainId').then(parseSendReturn);
            ...
            case 11:
              ...
              _context3.prev = 12;
              _context3.next = 15;
              return window.eth.send('net_version').then(parseSendReturn);
            ...
            case 21:
              if (!chainId) {
                try {
                  chainId = parseSendReturn(window.eth.send({
                    method: 'net_version'
                  }));
                } catch (_unused3) {
              ...
              if (!chainId) {
                if (window.eth.isDapper) {
                  chainId = parseSendReturn(window.eth.cachedResults.net_version);
                } else {
                  chainId = window.eth.chainId || window.eth.netVersion || window.eth.networkVersion || window.eth._chainId;
                }
              }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              _context4.prev = 2;
              _context4.next = 5;
              return window.eth.send('eth_accounts').then(function (sendReturn) {
                return parseSendReturn(sendReturn)[0];
              });
            ...
            case 21:
              if (!account) {
                account = parseSendReturn(window.eth.send({
                  method: 'eth_accounts'
                }))[0];
              }
  ...
  return CoinWalletConnector;
}(AbstractConnector);

export { CoinWalletConnector, NoEthereumProviderError, UserRejectedRequestError };
//# sourceMappingURL=coinwallet-connector.esm.js.map
